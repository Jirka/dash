 ...
 *
 */
public class SimpleMetricAnalysisUI extends FolderAnalysisUI {
	...
	public SimpleMetricAnalysisUI(MetricType[] availableMetricTypes) {
		super(new SimpleMetricAnalysis());
	...
	protected void getCustomSettings(JPanel panel) {
		...
		SimpleMetricAnalysis simpleMetricAnalysis = (SimpleMetricAnalysis) analysis;
