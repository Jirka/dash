...
public class MyRasterSymmetry extends AbstractWidgetRasterMetric {
	...
	public MyRasterSymmetry(RasterRatioCalculator ratioCalculator, int normalizationType) {
	...
	public MetricResult[] measure(Dashboard dashboard, GEType[] types) {
		...
		if(df != null) {
			...
			if(ratioCalculator instanceof DummyRatioCalculator) {
