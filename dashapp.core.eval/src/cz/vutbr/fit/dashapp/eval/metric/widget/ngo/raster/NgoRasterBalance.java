...
public abstract class NgoRasterBalance extends AbstractWidgetMetric {
	...
	public double getBalance(Dashboard dashboard, GEType[] types, ColorChannel[][] image, int dimension) {
		...
		for (GraphicalElement ge : ges) {
			double ratio = getRatio(image, ge);
			//if(ratio == Double.NaN) {
				ratio = getRatio(image, ge);
			//}
	...
	protected abstract double getRatio(ColorChannel[][] matrix, GraphicalElement ge);
	...
	public static class NgoIntensityBalance extends NgoRasterBalance {

		@Override
		protected double getRatio(ColorChannel[][] matrix, GraphicalElement ge) {
			ColorChannel[][] cropMatrix = MatrixUtils.cropMatrix(matrix, new Rectangle(ge.x, ge.y, ge.width, ge.height));
	...
	public static class NgoColorfulnessBalance extends NgoRasterBalance {
	...
	public static class NgoHSBBalance extends NgoRasterBalance {
	...
	public static class NgoHSBBalance2 extends NgoHSBBalance {
	...
	public static class NgoHSBBalance4 extends NgoHSBBalance {
